...
class ImportLocationCommand extends ContainerAwareCommand
{
    ...
    {
        $this
            ->setName('data:import-location')
            ->setDescription('Import bus stop from CSV into database')
            ->addArgument(
                'file',
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $locationImporter = $this->getContainer()->get('csg_data.service.location_importer');
